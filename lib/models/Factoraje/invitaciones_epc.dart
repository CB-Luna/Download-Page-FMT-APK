...
class InvitacionesEpc {
  ...
  factory InvitacionesEpc.fromJson(String str) => InvitacionesEpc.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory InvitacionesEpc.fromMap(Map<String, dynamic> json) => InvitacionesEpc(
